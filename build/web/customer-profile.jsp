<%-- 
    ...
    Created on : 11 Sep, 2023, 11:57:32 AM
    Author     : Sanket Mal
--%>
              ...
              <div>
                ...
                <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                  <ul id="sidebarnav">
                    ...
                    <li class="nav-small-cap sidebar-item"><a class="sidebar-link active" href="customer-profile.jsp"><i class="bi bi-person-circle"></i>profile</a></li>
                  ...
                  <% 
                    //  Establish a database connection
                      ...
                      // Execute a query to retrieve admin details     
                          String query = "SELECT * FROM user WHERE user_id = " + userId + " AND user_role = 2 AND user_active = 1"; 
