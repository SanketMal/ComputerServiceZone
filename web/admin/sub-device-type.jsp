...
<html>
            ...
            <div class="row">
                <div class="add-section bg-light mt-2 mb-2">
                    <form action ="../AddSubDeviceType" method="POST">
                        ...
                        <!-- For Edit -->
                        <input type="hidden" name="subDeviceId" class="subDevice-id" value="0">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="../AddSubDeviceType" method="POST">
                            <input type="hidden" name="subDeviceId" class="delete-sub-device-id">
    ...
    <script src="../assets/js/admin/sub-device-type.js"></script>
