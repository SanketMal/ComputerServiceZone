<%-- 
    ...
    Created on : 11 Sep, 2023, 12:08:11 PM
    Author     : Sanket Mal
--%>
...
%>
        ...
        <link href="assets/css/customer-feedback.css" rel="stylesheet">
              ...
              <div>
                ...
                <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                  <ul id="sidebarnav">
                    ...
                    <li class="nav-small-cap sidebar-item"><a class="sidebar-link active" href="customer-feedback.jsp"><i class="bi bi-chat-quote"></i>Feedback</a></li>
...
<!--                <div class="row"> comment 
                    <div class="form-group mb-3 col-md-6">
                        <div class="row">
                            ...
                            <div class="col-md-8"> comment 
                                <input type="text" class="form-control" name="firstName"> comment 
                            </div>    
                        </div>
                    </div>
                    <div class="form-group mb-3 col-md-6">
                        <div class="row">
                            ...
                            <div class="col-md-8"> comment 
                                <input type="text" class="form-control" name="lastName"> comment 
                            </div>    
                        </div>
                    </div>        
                </div>     
                <div class="row"> comment 
                    <div class="form-group mb-3 col-md-6">
                        <div class="row">
                            ...
                            <div class="col-md-8"> comment 
                                <input type="email" class="form-control" name="email"> comment 
                            </div>    
                        </div>
                    </div>
                    <div class="form-group mb-3 col-md-6">
                        <div class="row">
                            ...
                            <div class="col-md-8"> comment 
                                <input type="text" class="form-control" name="phone"> comment 
                            </div>    
                        </div>
                    </div>        
                </div>-->
    ...
    <script src="assets/js/customer/customer-feedback.js"></script>
</html>
