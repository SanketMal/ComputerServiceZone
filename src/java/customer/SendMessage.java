...
public class SendMessage extends HttpServlet {
    ...
    try {
        ...
        if (result > 0) {
            response.sendRedirect(request.getContextPath()+"/index.jsp?message="+ ResponseMessage.messageSentSuccess);
        } else {
            response.sendRedirect(request.getContextPath()+"/index.jsp?message="+ ResponseMessage.messageSentFail);
        }
